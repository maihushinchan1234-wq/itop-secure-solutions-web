...
const BlogPost = () => {
  ...
  const blogPosts = {
    '1': {
      ...
      content: `
        <div class="prose prose-lg max-w-none">
          <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg mb-8 border-l-4 border-blue-500">
          ...
          <p class="mb-6 text-gray-700 leading-relaxed">Smart door locks are advanced security devices that eliminate the need for traditional physical keys. Instead, they use modern technology like Bluetooth connectivity, Wi-Fi networks, fingerprint recognition, numeric keypads, or smartphone apps to grant access. Think of them as your personal security guard that never sleeps and always remembers who should and shouldn't enter your home.</p>
            ...
            <ul class="space-y-3">
              <li class="flex items-start">
                ...
                <div>
                  ...
                  <span class="text-green-700"> Lock or unlock your door from anywhere in the world using your smartphone. Perfect for letting in family members, service providers, or guests when you're not home.</span>
                </div>
              </li>
              <li class="flex items-start">
                <CheckCircle class="h-5 w-5 text-green-600 mt-1 mr-3 flex-shrink-0" />
                <div>
                  ...
                  <span class="text-green-700"> Create one-time or time-limited access codes for housekeepers, repair technicians, Airbnb guests, or family members. Codes expire automatically for maximum security.</span>
                </div>
              </li>
              <li class="flex items-start">
                <CheckCircle class="h-5 w-5 text-green-600 mt-1 mr-3 flex-shrink-0" />
                <div>
                  ...
                  <span class="text-green-700"> Receive instant notifications on your phone if someone attempts to tamper with the lock, enters the wrong code multiple times, or if the door is left unlocked.</span>
                </div>
              </li>
              <li class="flex items-start">
                <CheckCircle class="h-5 w-5 text-green-600 mt-1 mr-3 flex-shrink-0" />
                <div>
                  ...
                  <span class="text-green-700"> Monitor who enters and exits your home with detailed logs showing timestamps. Perfect for keeping track of children, elderly family members, or service providers.</span>
                </div>
              </li>
            </ul>
          </div>

          <h3 class="text-xl font-semibold text-gray-800 mb-4">🏆 Top Smart Lock Brands We Install & Service:</h3>
          <div class="grid md:grid-cols-2 gap-4 mb-8">
            <div class="bg-white p-4 border border-gray-200 rounded-lg shadow-sm">
              <h4 class="font-semibold text-blue-600 mb-2">Qubo Smart Locks</h4>
            ...
            <div class="bg-white p-4 border border-gray-200 rounded-lg shadow-sm">
              <h4 class="font-semibold text-blue-600 mb-2">Yale Digital Locks</h4>
            ...
            <div class="bg-white p-4 border border-gray-200 rounded-lg shadow-sm">
              <h4 class="font-semibold text-blue-600 mb-2">Godrej Smart Locks</h4>
            ...
            <div class="bg-white p-4 border border-gray-200 rounded-lg shadow-sm">
              <h4 class="font-semibold text-blue-600 mb-2">Hafele Digital Locks</h4>
          ...
          <div class="bg-yellow-50 p-6 rounded-lg mb-8 border border-yellow-200">
            ...
            <ul class="space-y-2 text-yellow-700">
              <li>• <strong>Free Home Visit:</strong> Our expert evaluates your door and recommends the best lock</li>
              ...
              <li>• <strong>6-Month Service Warranty:</strong> Free maintenance and support for 6 months</li>
              <li>• <strong>24/7 Emergency Support:</strong> Locked out? We provide immediate assistance</li>
            </ul>
          </div>

          <h3 class="text-xl font-semibold text-gray-800 mb-4">🏠 Choosing the Right Lock for Your Door Type:</h3>
          <div class="space-y-4 mb-8">
            ...
            <div class="border-l-4 border-green-400 pl-4">
              <h4 class="font-semibold text-gray-800">Metal/Steel Doors</h4>
    ...
    '2': {
      ...
      content: `
        <div class="prose prose-lg max-w-none">
          <div class="bg-gradient-to-r from-purple-50 to-blue-50 p-6 rounded-lg mb-8 border-l-4 border-purple-500">
